...
struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0x52bd, (ISR)0x820d}, /* 13 */
	{(const void *)0x8bbc, (ISR)0x3821}, /* 14 */
